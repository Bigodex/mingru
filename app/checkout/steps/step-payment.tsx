...
export default function StepPayment({
  ...
  // Classes para usar o chevron embutido do AccordionTrigger:
  // - seta padrão para cima: rotate-180
  // - no hover, gira para baixo: rotate-0
        ...
        >
          ...
          >
            ...
            <AccordionItem value="credit-card" className="border rounded-lg">
              <AccordionTrigger
                className={triggerChevronClasses}
